           ...
           <h1 data-aos="fade-up" class="text-4xl text-center font-bold text-orange-600 my-10 uppercase titlehead aos-init aos-animate">Contact</h1>
            <div class="container px-5 mx-auto flex sm:flex-nowrap flex-wrap">
                    <div class="lg:w-2/3 md:w-1/2 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative aos-init aos-animate" data-aos="fade-right">
                        <iframe data-aos="fade-up" width="100%" height="100%" title="map" class="absolute inset-0 aos-init aos-animate" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d543.0564134288818!2d90.43934814817825!3d23.703353120422125!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjPCsDQyJzExLjkiTiA5MMKwMjYnMjMuNSJF!5e0!3m2!1sen!2sbd!4v1684730247253!5m2!1sen!2sbd"></iframe>
                           ...
                           <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 class="title-font font-semibold text-white tracking-widest text-xs aos-init aos-animate" data-aos="fade-right">EMAIL</h2>
                               <a href="mailto:Faizulhaque2021@gmail.com" class="text-red-400 leading-relaxed cursor-pointer aos-init" data-aos="fade-right">Faizulhaque2021@gmail.com</a>
                                 <h2 class="title-font font-semibold text-white tracking-widest text-xs mt-4 aos-init" data-aos="fade-right">PHONE</h2><a href="tel:+8801713627446" class="text-red-400 leading-relaxed cursor-pointer aos-init" data-aos="fade-right">+8801713627446</a>
                                 </div>
                                 </div>
                    </div>
                                        ...
                                        <form class="flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
                                            <div class="relative mb-4">
                                             ...
                                             <div class="relative mb-4">
                                                ...
                                                <textarea id="message" name="message" required="" class="w-full bg-gray-800 rounded border border-gray-700 focus:border-red-500 focus:ring-2 focus:ring-red-900 h-32 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out aos-init aos-animate" data-aos="fade-right"></textarea></div>
                                                <button class="text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg aos-init" data-aos="fade-up">Submit</button>
                                                </form>
