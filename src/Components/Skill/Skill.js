...
<p class="text-xl text-center text-white font-semibold mt-5 aos-init aos-animate" data-aos="zoom-in-left">Technology are required or talent needed in order to do a job or task.</p>
      ...
      <path d="M0 0h24v24H0V0zm22.034 18.276c-.175-1.095-.888-2.015-3.003-2.873-.736-.345-1.554-.585-1.797-1.14-.091-.33-.105-.51-.046-.705.15-.646.915-.84 1.515-.66.39.12.75.42.976.9 1.034-.676 1.034-.676 1.755-1.125-.27-.42-.404-.601-.586-.78-.63-.705-1.469-1.065-2.834-1.034l-.705.089c-.676.165-1.32.525-1.71 1.005-1.14 1.291-.811 3.541.569 4.471 1.365 1.02 3.361 1.244 3.616 2.205.24 1.17-.87 1.545-1.966 1.41-.811-.18-1.26-.586-1.755-1.336l-1.83 1.051c.21.48.45.689.81 1.109 1.74 1.756 6.09 1.666 6.871-1.004.029-.09.24-.705.074-1.65l.046.067zm-8.983-7.245h-2.248c0 1.938-.009 3.864-.009 5.805 0 1.232.063 2.363-.138 2.711-.33.689-1.18.601-1.566.48-.396-.196-.597-.466-.83-.855-.063-.105-.11-.196-.127-.196l-1.825 1.125c.305.63.75 1.172 1.324 1.517.855.51 2.004.675 3.207.405.783-.226 1.458-.691 1.811-1.411.51-.93.402-2.07.397-3.346.012-2.054 0-4.109 0-6.179l.004-.056z">
         ...
         <div class="logo-back rounded-2xl logoShadow text-orange-400 text-sm flex justify-center items-center">
            ...
            <div class="logo-cart aos-init aos-animate" data-aos="fade-up-right">
                <div class="logo-cart-inner">
                           <div class="logo-front logoShadow rounded-2xl flex justify-center items-center">
      <span class="text-orange-400 text-4xl"><svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
               <title></title>
   ...
   <span class="text-orange-400  text-4xl">
      ...
      <div class="logo-cart aos-init" data-aos="fade-up-left"><div class="logo-cart-inner">
        <div class="logo-front logoShadow rounded-2xl flex justify-center items-center">
         <span class="text-orange-400  text-4xl">
          <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
           <path stroke="none" d="M0 0h24v24H0z" fill="none">
            ...
            </div><div class="logo-cart aos-init" data-aos="fade-up-right">
            <div class="logo-cart-inner">
            <div class="logo-front logoShadow rounded-2xl flex justify-center items-center">
            <span class="text-orange-400 text-4xl">
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="logo-cart aos-init" data-aos="fade-up"><div class="logo-cart-inner">
               <div class="logo-front logoShadow rounded-2xl flex justify-center items-center">
            <span class="text-orange-400  text-4xl">
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            <title></title>
   ...
   <path d="M24 18.588a1.529 1.529 0 01-1.895-.72l-3.45-4.771-.5-.667-4.003 5.444a1.466 1.466 0 01-1.802.708l5.158-6.92-4.798-6.251a1.595 1.595 0 011.9.666l3.576 4.83 3.596-4.81a1.435 1.435 0 011.788-.668L21.708 7.9l-2.522 3.283a.666.666 0 000 .994l4.804 6.412zM.002 11.576l.42-2.075c1.154-4.103 5.858-5.81 9.094-3.27 1.895 1.489 2.368 3.597 2.275 5.973H1.116C.943 16.447 4.005 19.009 7.92 17.7a4.078 4.078 0 002.582-2.876c.207-.666.548-.78 1.174-.588a5.417 5.417 0 01-2.589 3.957 6.272 6.272 0 01-7.306-.933 6.575 6.575 0 01-1.64-3.858c0-.235-.08-.455-.134-.666A88.33 88.33 0 010 11.577zm1.127-.286h9.654c-.06-3.076-2.001-5.258-4.59-5.278-2.882-.04-4.944 2.094-5.071 5.264z">
     ...
     <div class="logo-back rounded-2xl logoShadow text-orange-400 text-sm flex justify-center items-center">
      ...
      <div class="logo-back rounded-2xl logoShadow text-orange-400 text-sm flex justify-center items-center">
         ...
         <div class="logo-cart aos-init" data-aos="fade-up">
            <div class="logo-cart-inner"><div class="logo-front logoShadow rounded-2xl flex justify-center items-center">
               <span class="text-orange-400 text-4xl">
                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                     <title></title>
            ...
            <div class="logo-back rounded-2xl logoShadow text-orange-400 text-sm flex justify-center items-center">
               <span>MongoDB</span>
                                 ...
                                 <div class="logo-cart aos-init" data-aos="fade-up">
                                    <div class="logo-cart-inner"><div class="logo-front logoShadow rounded-2xl flex justify-center items-center"><span class="text-orange-400  text-4xl">
                                       <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                          <title></title>
